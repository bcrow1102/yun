...
import TempleStayFilterTabs from "./TempleStayFilterTabs";
            ...
            <main>
                <section className="bg-[#FFF9DC]">
                    <div className="mx-auto max-w-6xl px-5 py-11 md:px-8 md:py-16">
                        ...
                        <div className="mt-7 flex max-w-2xl items-center gap-2 rounded-[14px] border border-[#EEE3A7] bg-white p-2 shadow-[0_4px_16px_rgba(25,31,40,0.05)]">
                            ...
                            <button className="rounded-lg bg-[#252A31] px-4 py-3 text-sm font-bold text-white">
                                검색
                            </button>
                        </div>
                    </div>
                ...
                <section className="border-b border-[#EEF0F2] bg-white">
                    <TempleStayFilterTabs />
                </section>

                <section className="mx-auto max-w-6xl px-4 py-8 md:px-8 md:py-12">
                    <h2 className="mb-5 text-[24px] font-bold tracking-[-0.035em] md:text-[28px]">
                        템플스테이 둘러보기
                    </h2>

                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                        {templeStayPrograms.map((program) => {
