            ...
            <section className="mx-auto max-w-3xl px-4 py-10 md:px-8 md:py-14">
                <div className="mb-8">
                    ...
                    <p className="mt-4 text-[15px] leading-7 text-[#667085]">
                        참가 확인과 안내를 위해 신청자 정보를 정확하게 입력해 주세요.
                    </p>
                </div>

                <section className="mb-6 rounded-[22px] border border-[#F0E4A3] bg-[#FFF9DC] p-5 md:p-6">
                    <p className="text-sm font-medium text-[#766900]">신청 프로그램</p>

                    <h2 className="mt-2 text-xl font-semibold">{program.name}</h2>

                    <dl className="mt-4 grid gap-3 text-sm text-[#5E574C] sm:grid-cols-2">
                        <div>
                            <dt className="text-xs text-[#8B7F5C]">운영 사찰</dt>
                            <dd className="mt-1">{program.temple}</dd>
                        </div>

                        <div>
                            <dt className="text-xs text-[#8B7F5C]">지역</dt>
                            <dd className="mt-1">{program.location}</dd>
                        </div>

                        <div>
                            <dt className="text-xs text-[#8B7F5C]">기간</dt>
                            <dd className="mt-1">{program.duration}</dd>
                        </div>
                    ...
                    <div className="grid gap-6">
                        ...
                        <label className={labelStyle}>
                            ...
                            <textarea
                                name="request"
                                rows={5}
                                placeholder="식사, 숙박 또는 참여와 관련해 미리 알려주실 내용이 있다면 적어주세요"
