            ...
            <article className="mx-auto max-w-[900px] px-5 py-12 md:px-8 md:py-16">
                <div className="border-b border-[#E5E7EA] pb-8">
                    ...
                    <p className="mt-4 max-w-[680px] break-keep text-sm font-normal leading-7 text-[#7B8490] md:text-[15px]">
                        이야기의 재미는 살리되, 어느 문헌에서 언제 전해졌는지를 함께 밝힙니다.
                    </p>
                </div>
                    ...
                    {article.stories.map((story) => (
                        ...
                        >
                            ...
                            <div className="p-5 md:p-6">
                                <p className="break-keep text-[15px] font-normal leading-8 text-[#4E5968]">
                                    {story.text}
                                </p>
                                ...
                                <div className="mt-5 rounded-[16px] bg-[#F7F8FA] px-4 py-4">
                                    ...
                                    <p className="mt-1.5 break-keep text-sm font-normal leading-7 text-[#596270]">
                                        {story.meaning}
                                    </p>
                                </div>
                            </div>
